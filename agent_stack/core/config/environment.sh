...
export SYSTEM_COMMANDS_DIR="$SYSTEM_DIR/System_Commands"
export WORK_LOGS_DIR="$SYSTEM_DIR/Work_Logs"
export SYSTEM_LOGS_DIR="$SYSTEM_DIR/System_Logs"
export WARP_RULES_DIR="$SYSTEM_DIR/Warp_Rules"
export CURRENT_OBJECTIVE_DIR="$SYSTEM_DIR/Current_Objective"
export FUTURE_OBJECTIVES_DIR="$SYSTEM_DIR/Future_Objectives"
export PAST_OBJECTIVES_DIR="$SYSTEM_DIR/Past_Objectives"
export AGENT_STATUS_DIR="$SYSTEM_DIR/Agent_Status"
export TASK_POOL_DIR="$SYSTEM_DIR/Task_Pool"
export DEPENDENCIES_DIR="$SYSTEM_DIR/Dependencies"
export MISSING_TASKS_DIR="$SYSTEM_DIR/Missing_Tasks"
export PROMOTION_QUEUE_DIR="$SYSTEM_DIR/Promotion_Queue"
export INSTALLED_TOOLS_DIR="$SYSTEM_DIR/Installed_Tools"
...
export BACKUP_DIR="$SYSTEM_DIR/Backups"
...
export EMERGENCY_BACKUP_DIR="$SYSTEM_DIR/Emergency_Backups"
...
mkdir -p \
    ...
    "$WARP_RULES_DIR" \
    "$INSTALLED_TOOLS_DIR" \
    "$DEVSTACK_DIR/agent_stack/core/rules" \
    "$AGENT_COMMENTS_DIR" \
    "$BACKUP_DIR" \
